...
export  class UserPostController {
    ...
    signInUser = async (req, res) => {
        ...
        //Recaptcha
        /*Client-Side CAPTCHA Check
        Client-Side Check: Prevents unnecessary calls to the Google API if the CAPTCHA field is not filled out properly.
     Server-Side Verification: Ensures that even if a user fills out the CAPTCHA field, 
     the response token is verified by Google to confirm its legitimacy.
         */
